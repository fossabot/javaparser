...
public class CloneVisitor implements GenericVisitor<Visitable, Object> {
    ...
    public Visitable visit(final JavadocComment n, final Object arg) {
        JavadocContent contentNode = this.cloneNode(n.getContentNode(), arg);
        Comment comment = this.cloneNode(n.getComment(), arg);
    ...
    public Visitable visit(final JavadocBlockTag n, final Object arg) {
        JavadocDescription description = this.cloneNode(n.getDescription(), arg);
        Comment comment = this.cloneNode(n.getComment(), arg);
    ...
    public Visitable visit(final JavadocContent n, final Object arg) {
        NodeList<JavadocBlockTag> blockTags = this.cloneList(n.getBlockTags(), arg);
        JavadocDescription description = this.cloneNode(n.getDescription(), arg);
        Comment comment = this.cloneNode(n.getComment(), arg);
    ...
    public Visitable visit(final JavadocDescription n, final Object arg) {
        NodeList<JavadocDescriptionElement> elements = this.cloneList(n.getElements(), arg);
        Comment comment = this.cloneNode(n.getComment(), arg);
