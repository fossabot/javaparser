...
public class ExpressionStmtContext extends AbstractJavaParserContext<ExpressionStmt> {

    public ExpressionStmtContext(ExpressionStmt wrappedNode, TypeSolver typeSolver) {
